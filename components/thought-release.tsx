      ...
      {!released ? (
        ...
        <div className="p-6 rounded-2xl bg-indigo-950/40 border border-indigo-500/30 text-center space-y-4 animate-fade-in">
          ...
          <div className="space-y-1">
            <h4 className="text-base font-bold text-white">{tr.badge}</h4>
